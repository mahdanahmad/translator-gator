...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<a ui-sref="oldadmin.statistic"  ng-click="activePage = 'statistic'">
		...
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start" ng-class="{'active' : activePage == 'statistic'}">
					<a href="javascript:;"  ui-sref="oldadmin.statistic" ng-click="activePage = 'statistic'">
				...
				<li ng-class="{'active' : activePage == 'words'}">
					<a href="javascript:;"  ui-sref="oldadmin.words" ng-click="activePage = 'words'">
				...
				<li ng-class="{'active' : activePage == 'general'}">
					<a href="javascript:;"  ui-sref="oldadmin.general" ng-click="activePage = 'general'">
				...
				<li ng-class="{'active' : activePage == 'category'}">
					<a href="javascript:;"  ui-sref="oldadmin.category" ng-click="activePage = 'category'">
					<i class="icon-grid"></i>
					<span class="title">Category Configuration</span>
					<span class="selected"></span>
					</a>
				<li ng-class="{'active' : activePage == 'language'}">
					<a href="javascript:;"  ui-sref="oldadmin.language" ng-click="activePage = 'language'">
				...
				<li class="last" ng-class="{'active' : activePage == 'redeem'}">
					<a href="javascript:;"  ui-sref="oldadmin.redeem" ng-click="activePage = 'redeem'">
