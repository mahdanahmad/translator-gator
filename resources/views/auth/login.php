<div id="login-container" class="col-md-8 col-xs-10 col-md-offset-2 col-xs-offset-1 animated fadeIn">
    <div class="header-wrapper"> <div class="header_logo"><img src="resources/img/transgator-logo.png"></div> </div>
    ...
    <div id="register-redirect"> <span ng-click="redirect_register()">REGISTER</span> </div>
    <div id="forgot-redirect"> <span ng-click="forgot_register()">FORGOT PASSWORD</span> </div>
