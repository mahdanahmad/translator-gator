<div id="reset-container" class="col-md-8 col-xs-10 col-md-offset-2 col-xs-offset-1">
    ...
    <form ng-submit="reset_password()" ng-show="show">
        ...
        <div ng-show="error" class="alert auth-error animated fadeIn" role="alert"> <p>{{message}}</p> </div>
